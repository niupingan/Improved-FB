 function [Cylinder, EndPlate1, EndPlate2] = cylinder3(X1,X2,r,n,cyl_color,closed,lines,transparency)  
%  
...
set(Cylinder,'facealpha',transparency);
set(EndPlate1,'facealpha',transparency);
set(EndPlate2,'facealpha',transparency);
grid on